    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Edit Currency</h1>
                    <p class="text-xs text-gray-600">Update currency - {{ $currency->name }}</p>
                </div>
            </div>
    ...
    <div class="form-card p-6">
        <form method="POST" action="{{ route('admin.currency.update', $currency->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-input" value="{{ $currency->name }}" required>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="code" id="code" class="form-input" value="{{ $currency->code }}" maxlength="3" style="text-transform: uppercase;" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="symbol" id="symbol" class="form-input" value="{{ $currency->symbol }}" maxlength="10" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="exchange_rate" id="exchange_rate" class="form-input" step="0.0001" min="0" value="{{ $currency->exchange_rate }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="status-toggle">
                        <label class="status-switch">
                            <input type="checkbox" name="status" id="status" {{ $currency->status == 'Active' ? 'checked' : '' }}>
                            <span class="status-slider"></span>
                        </label>
                        <span class="text-sm font-medium text-gray-700" id="statusLabel">{{ $currency->status }}</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">
                    ...
                    <div class="checkbox-group">
                        <input type="checkbox" name="is_default" id="is_default" value="1" {{ $currency->is_default ? 'checked' : '' }}>
