    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Country Report</h1>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.reports.country.export', $exportParams) }}" class="admin-btn-primary px-5 py-2.5 text-sm font-semibold flex items-center gap-2">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="overflow-x-auto rounded-lg border border-gray-200">
                    ...
                    <tbody>
                        @foreach($countries as $country)
                            <tr>
                                ...
                                <td class="font-semibold text-gray-700">{{ $country['name'] }}</td>
                                ...
                                <td>
                                    <span class="status-badge {{ strtolower($country['status']) == 'active' ? 'active' : 'inactive' }}">
                                        {{ $country['status'] }}
                                    </span>
                                </td>
                                <td class="text-sm text-gray-600">{{ $country['remark'] ?? '-' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">No Country Data Found</h3>
                    <p class="text-gray-600 text-sm">No country data available to display in the report.</p>
                </div>
            @endif
        </div>
    </div>
