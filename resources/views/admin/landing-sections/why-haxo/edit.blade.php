...
@section('title', 'Edit Why Haxo Section')
    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Edit Why Haxo Section</h1>
                    <p class="text-xs text-gray-600">Update the Why Haxo Shipping section content for the landing page</p>
                </div>
            </div>
        ...
        <div class="lg:col-span-2">
            <div class="form-card p-6">
                <h2 class="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    Why Haxo Section Content
                </h2>

                <form method="POST" action="{{ route('admin.why-haxo-section.update') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="why_haxo_section_title" id="why_haxo_section_title" class="form-input" placeholder="e.g., Why Haxo Shipping" value="{{ old('why_haxo_section_title', $settings->why_haxo_section_title) }}">
                        @error('why_haxo_section_title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="why_haxo_section_content" id="why_haxo_section_content" class="form-textarea" placeholder="Enter the Why Haxo section content here. This will be displayed on the landing page.">{{ old('why_haxo_section_content', $settings->why_haxo_section_content) }}</textarea>
                        @error('why_haxo_section_content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="form-card p-5 sticky top-6">
                ...
                <div class="space-y-3 text-xs text-gray-600">
                    <div class="flex items-start gap-2">
                        ...
                        <span>Section title will be displayed as the heading for the Why Haxo Shipping section.</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
