...
@section('title', 'Edit Pricing Section')
    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Edit Pricing Section</h1>
                    <p class="text-xs text-gray-600">Update the Haxo Shipping Pricing section content for the landing page</p>
                </div>
            </div>
            ...
            <div class="form-card p-6">
                ...
                <form method="POST" action="{{ route('admin.pricing-section.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pricing_section_title" id="pricing_section_title" class="form-input" placeholder="e.g., Haxo Shipping Pricing" value="{{ old('pricing_section_title', $settings->pricing_section_title) }}">
                        @error('pricing_section_title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pricing_section_content" id="pricing_section_content" class="form-textarea" placeholder="Enter the pricing section content here. This will be displayed on the landing page.">{{ old('pricing_section_content', $settings->pricing_section_content) }}</textarea>
                        @error('pricing_section_content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="form-card p-5 sticky top-6">
                ...
                <div class="space-y-3 text-xs text-gray-600">
                    <div class="flex items-start gap-2">
                        ...
                        <span>Section title will be displayed as the heading for the Haxo Shipping Pricing section.</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
