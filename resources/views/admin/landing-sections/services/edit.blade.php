    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Edit Our Services Section</h1>
                    <p class="text-xs text-gray-600">Update the Our Services section content for the landing page</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="form-card p-6">
                ...
                <form method="POST" action="{{ route('admin.services-section.update') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="services_section_title" id="services_section_title" class="form-input" placeholder="e.g., Our Services" value="{{ old('services_section_title', $settings->services_section_title) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="services_section_content" id="services_section_content" class="form-textarea" placeholder="Enter the services section content here. This will be displayed on the landing page.">{{ old('services_section_content', $settings->services_section_content) }}</textarea>
                        @error('services_section_content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="form-card p-5 sticky top-6">
                ...
                <div class="space-y-3 text-xs text-gray-600">
                    <div class="flex items-start gap-2">
                        ...
                        <span>Section title will be displayed as the heading for the Our Services section.</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
