                ...
                <form id="bookingForm" method="POST" action="{{ route('admin.bookings.update', $booking['id']) }}">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="origin_pin" id="origin_pin" class="form-input" value="{{ $booking['origin_pin'] }}" placeholder="e.g., 400001">
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                                <svg class="w-3.5 h-3.5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" name="destination_pin" id="destination_pin" class="form-input" value="{{ $booking['destination_pin'] }}" placeholder="e.g., 10001" required>
                        </div>
                    </div>
