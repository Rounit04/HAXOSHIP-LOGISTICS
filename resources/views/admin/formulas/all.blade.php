        ...
        <div class="formula-card p-6 mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="ml-auto flex items-center gap-3">
                    <button onclick="bulkDelete()" id="bulkDeleteBtn" class="px-4 py-2.5 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-700 transition text-sm hidden">
                        <div class="flex items-center gap-2">
