...
@section('content')
    ...
    <div class="page-header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-0.5">Create Formula</h1>
                    <p class="text-xs text-gray-600">Add a new formula - Single, bulk, editable Status (Active/Inactive)</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="form-card p-6">
                ...
                <form id="formulaForm" method="POST" action="{{ route('admin.formulas.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="formula_name" id="formula_name" class="form-input" placeholder="Type something" required>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="value" id="value" class="form-input" step="0.01" min="0" placeholder="e.g., 0.1 & 100" required>
                            <p class="text-xs text-gray-500 mt-1">Number (e.g., 0.1 & 100)</p>
                        </div>
                    </div>
    ...
    <div id="success-popup" class="success-popup" style="display: none;">
        ...
        <div class="flex-1">
            <p class="text-green-700 font-semibold text-sm" id="success-message">Formula created successfully!</p>
        </div>
            ...
            <div class="form-card p-5 sticky top-6">
                ...
                <div class="space-y-3 text-xs text-gray-600">
                    <div class="flex items-start gap-2">
                        ...
                        <span>Formula name should be descriptive</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
                    ...
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
                        <span>Type: Fixed or Percentage</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
                        <span>Scope: per kg or Flat</span>
                    </div>
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
                    ...
                    <div class="flex items-start gap-2">
                        <div class="w-1.5 h-1.5 rounded-full bg-purple-600 mt-1.5 flex-shrink-0"></div>
                        <span>Value: Number (e.g., 0.1 & 100)</span>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('formulaForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    // Show success popup
                    document.getElementById('success-message').textContent = data.message || 'Formula created successfully!';
                ...
                if (error.name === 'SyntaxError' || error.message.includes('JSON')) {
                    ...
                    alert('Error creating formula: ' + (error.message || 'Please try again.'));
                }
                submitButton.disabled = false;
                buttonText.textContent = originalText;
            }
